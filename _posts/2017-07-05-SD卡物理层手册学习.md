...
![]({{site.baseurl}}/images/驱动开发/SD/CSD1.jpg)

![]({{site.baseurl}}/images/驱动开发/SD/CSD2.jpg)
...
![]({{site.baseurl}}/images/驱动开发/SD/SCR.jpg)
...
![]({{site.baseurl}}/images/驱动开发/SD/card_status1.jpg)

![]({{site.baseurl}}/images/驱动开发/SD/card_status2.jpg)
...
flow
st_idle=>start: idle state
st_inactive=>start: inactive state
st_ready=>start: ready state
st_identification=>start: identification state
cmd_cmd0=>operation: CMD0
cmd_cmd8=>operation: CMD8
cmd_acmd41=>operation: ACMD41
cmd_cmd11=>operation: CMD11
cmd_cmd2=>operation: CMD2
cmd_cmd3=>operation: CMD3
